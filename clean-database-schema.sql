-- =====================================================
-- CarConnect Ghana - Clean Database Schema
-- =====================================================
-- This schema safely handles existing objects and creates everything needed
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_car_listings_user_id') THEN
        CREATE INDEX idx_car_listings_user_id ON car_listings(user_id);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_car_listings_status') THEN
        CREATE INDEX idx_car_listings_status ON car_listings(status);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_car_listings_make') THEN
        CREATE INDEX idx_car_listings_make ON car_listings(make);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_car_listings_model') THEN
        CREATE INDEX idx_car_listings_model ON car_listings(model);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_car_listings_price') THEN
        CREATE INDEX idx_car_listings_price ON car_listings(price);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_car_listings_year') THEN
        CREATE INDEX idx_car_listings_year ON car_listings(year);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_car_listings_location') THEN
        CREATE INDEX idx_car_listings_location ON car_listings(location);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_car_listings_is_featured') THEN
        CREATE INDEX idx_car_listings_is_featured ON car_listings(is_featured);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_car_listings_created_at') THEN
        CREATE INDEX idx_car_listings_created_at ON car_listings(created_at);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_car_listings_expires_at') THEN
        CREATE INDEX idx_car_listings_expires_at ON car_listings(expires_at);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_car_listings_search') THEN
...
BEGIN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_payments_verified_at') THEN
...
BEGIN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_subscriptions_next_payment_at') THEN
...
SELECT 'CarConnect Ghana Clean Database Schema Setup Complete!' as status;
