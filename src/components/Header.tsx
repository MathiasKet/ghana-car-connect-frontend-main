    ...
    <header className="sticky top-0 z-50 bg-white border-b shadow-sm">
      <div className="container flex items-center justify-between h-16 px-4 mx-auto md:px-8">
        ...
        <nav className="hidden md:flex md:items-center md:space-x-6">
          ...
          <Link to="/electric" className="text-sm font-medium hover:text-primary">Electric Cars</Link>
          ...
          <div className="fixed inset-0 z-50 flex flex-col pt-16 bg-white md:hidden">
            <div className="container px-4 py-6">
              <nav className="flex flex-col space-y-4">
                ...
                <Link to="/electric" className="flex items-center py-2 text-lg font-medium border-b">
                  <Zap className="w-5 h-5 mr-3" /> Electric Cars
                </Link>
