        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/estimate" className="text-gray-400 hover:text-white">Car Valuations</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/vehicle-inspection" className="text-gray-400 hover:text-white">Vehicle Inspection</Link></li>
              <li><Link to="/car-insurance" className="text-gray-400 hover:text-white">Car Insurance</Link></li>
              <li><Link to="/car-financing" className="text-gray-400 hover:text-white">Car Financing</Link></li>
              <li><Link to="/car-transport" className="text-gray-400 hover:text-white">Car Transport</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li>Accra, Ghana</li>
              <li>121 Independence Avenue</li>
              <li>+233 59 181 8492</li>
              <li>info@carconnectghana.com</li>
