...
CREATE TABLE IF NOT EXISTS public.car_listings (
  ...
  body_type TEXT CHECK (body_type IN ('sedan', 'suv', 'truck', 'van', 'luxury', 'hatchback', 'coupe', 'convertible')),
  listing_type TEXT DEFAULT 'sell' CHECK (listing_type IN ('sell', 'rent')),
